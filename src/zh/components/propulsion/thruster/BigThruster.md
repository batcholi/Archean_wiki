...
# Description
Big Thruster 通过液体燃料与液氧的燃烧产生推力。
它可以使用 CH4（甲烷）和 H2（氢气）作为燃料。
它使用径向气尖喷管，能够高效地将燃烧能量直接转化为推力。
它可以从 100 Kg/s 液氧和 12.5 Kg/s H2 的流量产生高达 1.8 MN 的推力。

# Usage
将高流量氧化剂和燃料连接到流体端口，高压用于点火，在数据端口发送 1 以点火。

初始点火仅在燃料或氧化剂流量介于 1 g/s 和 50 kg/s 之间时发生。
...
Big Thruster 的喷嘴可以在两个轴上进行 -10 到 +10 度的万向节调整。
