...
# Description
Le NavInstrument est un composant d'aide a la navigation. Il offre trois modes de fonctionnement :
...
# Usage
Le NavInstrument necessite une alimentation basse tension et consomme 200 watts.
Chaque mode a un affichage unique sur l'ecran du NavInstrument. Pour basculer entre les modes, cliquez simplement sur l'ecran avec la touche `F`.
