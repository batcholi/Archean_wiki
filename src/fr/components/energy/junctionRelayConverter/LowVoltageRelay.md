...
# Description
Le LowVoltageRelay est un dispositif qui alimente un composant en ne laissant passer le courant que si une valeur de signal non nulle est envoyée à son port de données.
