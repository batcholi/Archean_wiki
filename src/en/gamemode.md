...
- The respawn shortcut accessible via `Shift+F10` allows you to respawn without dropping the contents of your inventory.
- Mining and crafting are available, but not necessary for building structures or vehicles.
- Fluid temperature can be set manually via GetInfo (V) on tanks and volumes.
...
## Changing the game mode of an existing world
You can change the game mode of an existing world at any time using the launcher.

1. In the play solo menu, click the **gear icon** (⚙️) on the right side of the world entry
2. Select **Edit**
3. Change the game mode setting
4. Save your changes

You can also rename or duplicate worlds from this menu.