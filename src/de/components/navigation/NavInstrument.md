...
# Description
Das NavInstrument ist eine Navigationshilfe-Komponente. Es bietet drei Betriebsmodi:
...
# Usage
Das NavInstrument benötigt Niederspannung und verbraucht 200 Watt.
Jeder Modus hat eine eigene Anzeige auf dem NavInstrument-Bildschirm. Um zwischen den Modi zu wechseln, klicken Sie einfach mit der `F`-Taste auf den Bildschirm.
