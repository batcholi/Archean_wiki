...
# Description
Das MiniNavInstrument ist eine kompakte Version des [NavInstrument](NavInstrument.md). Es bietet die gleiche Navigationsfunktionalität in einem kleineren Formfaktor, ideal für Armaturenbretter, kleine Fahrzeuge oder wenn der Platz begrenzt ist.

Im Gegensatz zum vollwertigen NavInstrument hat das MiniNavInstrument keinen "OFF"-Modus - es startet standardmäßig im Flight-Modus, wenn kein Modus angegeben ist.

# Usage
Das MiniNavInstrument benötigt Niederspannung (200 W).
Es bietet die gleichen drei Betriebsmodi wie das NavInstrument:
- **Flight**: Navigation in der Umgebung eines Himmelskörpers
- **Orbit**: Navigation in der Umlaufbahn
- **Locator**: Objekt oder Himmelskörper lokalisieren

Um zwischen den Modi zu wechseln, senden Sie einen Moduswert auf Kanal 6 über den Datenport.
...
> Siehe die Dokumentation des [NavInstrument](NavInstrument.md) für detaillierte Informationen zu jedem Ausgang.
