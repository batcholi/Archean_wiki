...
# Description
Das Wheel ist eine Komponente, die es einem Build ermöglicht, vorwärts/rückwärts zu beschleunigen sowie zu lenken und zu bremsen. Es enthält eine konfigurierbare Federung und ein Getriebe.
...
#### Configuration
- `Mudguard`: Kotflügel anzeigen/ausblenden.
- `Reverse`: Drehrichtung des Rades umkehren.
- `Grip`: Griffigkeit des Rades anpassen.
- `Suspension`: Federung des Rades anpassen.

### Energy
Das Wheel hat einen Niederspannungs-Energieport und einen Hochspannungs-Energieport.
### Low-Voltage Energy
In dieser Konfiguration verbraucht das Rad bis zu 20 kW.
#### High-Voltage Energy
In dieser Konfiguration verbraucht das Rad bis zu 200 kW.
