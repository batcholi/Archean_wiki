...
## Archean XenonCode Dokumentation

Dies ist die erweiterte Dokumentation zur Archean-spezifischen Implementierung von XenonCode.

Für die grundlegende Syntax von XenonCode siehe [Dokumentation](documentation.md).
Je nach Kontext sind einige Funktionen möglicherweise nicht verfügbar oder verhalten sich anders. Spezifische Seiten für diese Kontexte sind verfügbar für weitere Details:
...
## Archean-spezifische Funktionen in allen Kontexten verfügbar
### Includes
Includes sind nützlich, um Funktionalität zwischen Programmen zu teilen, mehrere Programme zu einem zusammenzuführen oder einfach deine Programme sauber und organisiert zu halten.
```xc
