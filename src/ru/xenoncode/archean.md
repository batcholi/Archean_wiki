...
Это расширенная документация, относящаяся к реализации XenonCode, специфичной для Archean.

Базовый синтаксис XenonCode описан в [Documentation](documentation.md).
В зависимости от контекста, некоторые функции могут быть недоступны или вести себя по-другому. Для более подробной информации доступны отдельные страницы для этих контекстов:
...
### Includes
Include полезны для обмена функциональностью между программами, объединения нескольких программ в одну или просто для поддержания чистоты и организованности ваших программ.
```xc
