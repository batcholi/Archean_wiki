...
# Description
NavInstrument — навигационный компонент. Он предлагает три режима работы:
...
# Usage
NavInstrument требует низковольтного питания и потребляет 200 Вт.
Каждый режим имеет уникальное отображение на экране NavInstrument. Для переключения между режимами нажмите на экран клавишей `F`.
