...
Esta es la documentacion extendida relacionada con la implementacion especifica de Archean de XenonCode.

Para la sintaxis basica de XenonCode, consulta la [Documentation](documentation.md).
Segun el contexto, algunas funcionalidades pueden no estar disponibles o comportarse de manera diferente. Hay paginas especificas disponibles para estos contextos con mas detalles:
...
## Funcionalidades especificas de Archean disponibles en todos los contextos
### Includes
Los includes son utiles para compartir funcionalidad entre programas, fusionar multiples programas en uno, o simplemente mantener tus programas limpios y organizados.
```xc
