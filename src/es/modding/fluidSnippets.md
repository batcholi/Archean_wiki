...
Aqui hay algunos ejemplos de scripts XenonCode que demuestran el uso de fluidos en modding con XenonCode.

En los siguientes ejemplos, usamos una macro Slider para controlar los componentes. Esto puede mantenerse tal cual en la interfaz de usuario o reemplazarse con otra fuente de entrada (por ejemplo, un componente Throttle, interruptor, etc.).
```xc
#INFO slider "slider" 0 -1 1 "throttle"
```

El componente usado para crear estos ejemplos tiene un puerto de entrada de fluidos llamado "fluid-in" y un puerto de salida de fluidos llamado "fluid-out".
Estos ejemplos se proporcionan como referencia y pueden adaptarse a tus necesidades.
