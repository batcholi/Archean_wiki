...
# Description
El NavInstrument es un componente de ayuda a la navegación. Ofrece tres modos de funcionamiento:
...
# Usage
El NavInstrument requiere energía de bajo voltaje y consume 200 vatios.
Cada modo tiene una visualización única en la pantalla del NavInstrument. Para cambiar entre modos, simplemente haz clic en la pantalla con la tecla `F`.
