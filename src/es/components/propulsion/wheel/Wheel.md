...
# Description
La Wheel es un componente que permite a una construcción acelerar hacia adelante/atrás, así como girar y frenar. Incluye una suspensión y caja de cambios configurables.
...
#### Configuración
- `Mudguard`: Mostrar/Ocultar el guardabarros.
...
### Energía
La rueda tiene un puerto de energía de bajo voltaje y un puerto de energía de alto voltaje.
### Bajo voltaje
En esta configuración, la rueda consume hasta 20 kw.
#### Alto voltaje
En esta configuración, la rueda consume hasta 200 kw.
