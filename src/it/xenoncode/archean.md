...
Questa e' la documentazione estesa relativa all'implementazione specifica di XenonCode per Archean.

Per la sintassi base di XenonCode, consulta la [Documentation](documentation.md).
A seconda del contesto, alcune funzionalita' potrebbero non essere disponibili o comportarsi diversamente. Pagine specifiche per questi contesti sono disponibili per maggiori dettagli:
...
### Includes
Gli include sono utili per condividere funzionalita' tra programmi, unire piu' programmi in uno, o semplicemente per mantenere i tuoi programmi puliti e organizzati.
```xc
