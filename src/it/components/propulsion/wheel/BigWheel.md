...
# Description
La Big Wheel e' un componente che permette a una costruzione di accelerare avanti/indietro, sterzare e frenare. Include sospensioni e cambio configurabili.
...
### Energy
La Big Wheel puo' essere alimentata solo ad alta tensione a differenza della [Wheel](Wheel.md).
Consumera' fino a 400 kW alla massima potenza.
