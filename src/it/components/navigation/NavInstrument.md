...
# Description
Il NavInstrument e' un componente di ausilio alla navigazione. Offre tre modalita' operative:
...
# Usage
Il NavInstrument richiede alimentazione a bassa tensione e consuma 200 watt.
Ogni modalita' ha una visualizzazione unica sullo schermo del NavInstrument. Per passare da una modalita' all'altra, basta fare clic sullo schermo con il tasto `F`.
